...
var _LocalStorageDao = require('./LocalStorageDao');
...
var _EnemyType = require('./settings/EnemyType1');

var _EnemyType2 = _interopRequireDefault(_EnemyType);

var _EnemyType3 = require('./settings/EnemyType2');
...
var GameArena = function () {
    function GameArena(element, fieldWidth, fieldHeight, Person) {
        ...
        this.enemies.push(new _EnemyType2.default());
        this.enemies.push(new _EnemyType2.default(this.ctx, 15, 15, 'blue', 300, 600, -3)); // just horiz moving
        this.enemies.push(new _EnemyType4.default(this.ctx, 32, 32, 'blue', 600, 600, 0, 'right'));
        this.enemies.push(new _EnemyType4.default(this.ctx, 32, 32, 'blue', 650, 650, 0, 'left'));
        this.enemies.push(new _EnemyType4.default(this.ctx, 16, 16, 'blue', 700, 700, 0, 'down'));
        this.enemies.push(new _EnemyType4.default(this.ctx, 16, 16, 'blue', 750, 750, 0, 'up'));
    ...
    _createClass(GameArena, [{
        ...
        value: function finishGame() {
            ...
            (0, _script.resetStartButtonToInitialState)();
            this.resetScore();
            _GameArenaInstance2.default.setGameArenaInstance(new GameArena(this.canvas, this.canvas.width, this.canvas.height, _Person2.default));
            this.clear();
        }
    }, {
        key: 'replayLastGame',
        value: function replayLastGame() {
            ...
            gamesFrommDB.once('value').then(function (element) {
                ...
                var foundGame = _this3.fbDao.loadGame(lastGameId);
                foundGame.once('value').then(function (element) {

                    _this3.frames = JSON.parse(Object.values(element.val())[0]);
                    _this3.interval = setInterval(_this3.drawFrame2.bind(_this3), 50);
                });
            });
        }
    }, {
        ...
        value: function replaySelectedGame(gameId) {
            ...
            gamesFrommDB.once('value').then(function (element) {
                ...
                var foundGame = _this4.fbDao.loadGame(gameId);
                foundGame.once('value').then(function (element) {
        ...
        value: function drawFrame2() {
            ...
            frame.enemies.forEach(function (object) {
                ...
                if (item.visionRadius) {
                    enemy = new _EnemyType2.default(_this5.ctx, item.width, item.height, item.color, item.x, item.y, item.speedV, item.speedH, item.visionRadius, item.i);
                    enemy.update(_this5.ctx, showRadiuses);
                } else {
                    enemy = new _EnemyType4.default(_this5.ctx, item.width, item.height, item.color, item.x, item.y, item.i);
                    enemy.update(_this5.ctx);
                }
            });
        ...
        value: function drawFrame() {
            ...
            hero1FromDB.once('value').then(function (element) {
                ...
                var person = new _Person2.default(_this6.ctx, hero.width, hero.height, hero.color, hero.x, hero.y, hero.imgWidth, hero.imgHeight, hero.moveDirection, hero.i);
                person.update(_this6.ctx);
                _this6.stepId++;
            });
        }
    }]);
...
},{"./Dao":1,"./DrawService":2,"./GameArenaInstance.js":4,"./GameCache":5,"./Levels":6,"./LocalStorageDao":7,"./Person":8,"./script":12,"./settings/EnemyType1":14,"./settings/EnemyType2":15}],4:[function(require,module,exports){
"use strict";
    ...
    _createClass(Levels, null, [{
        ...
        value: function getLevels() {
            return [{
                winScoreLimit: 50,
                imgSource: undefined,
                enemies: [new _EnemyType2.default(), new _EnemyType2.default(this.ctx, 15, 15, 'blue', 300, 600, -3)]
            }, {
                winScoreLimit: 60,
                imgSource: undefined,
                enemies: [new _EnemyType4.default()]
            }, {
                winScoreLimit: 70,
                imgSource: undefined,
                enemies: [new _EnemyType2.default(this.ctx, 20, 20, 'orange', 300, 800, -4)]
            }];
        }
    }]);
...
},{"./settings/EnemyType1":14,"./settings/EnemyType2":15}],7:[function(require,module,exports){
'use strict';
...
var _PersonImgSettings = require('./PersonImgSettings');
...
},{"./GameArenaInstance.js":4,"./PersonImgSettings":9}],9:[function(require,module,exports){
"use strict";
...
},{"./script":12}],12:[function(require,module,exports){
'use strict';
...
},{"./Dao":1,"./DrawService":2,"./GameArena":3,"./GameArenaInstance.js":4,"./LocalStorageDao":7,"./Person":8,"./Router":10}],13:[function(require,module,exports){
"use strict";
...
var _JesusImgSettings = require('./JesusImgSettings');
...
},{"../GameArenaInstance.js":4,"../Person":8,"./JesusImgSettings":16}],15:[function(require,module,exports){
'use strict';
...
var _CatImgSettings = require('./CatImgSettings');
...
},{"../Person":8,"./CatImgSettings":13}],16:[function(require,module,exports){
"use strict";
